...
#define kBufferSize 1000*1000 // 1 MB
#define kDefaultRequestTimeout 30
#define kNumberOfSamples 5

#define TCBlobDownloadErrorDomain @"com.thibaultcha.tcblobdownload"
#define TCBlobDownloadErrorHTTPStatusKey @"TCBlobDownloadErrorHTTPStatusKey"
